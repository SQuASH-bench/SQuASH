...
def fit(model_name, params, train_loader, val_loader, test_loader, loss_fn):
    ...
    best_model_path = os.path.join(params['PATHS']['trained_models'], f'gcn_{model_name}.pth')
...
if __name__ == "__main__":
    ...
    save_data(os.path.join(path_config.paths['test_data'], f'test_gcn_{gate_set_name}.pt'), test_data)
